        ...
        for (int i = -size / 2; i < size / 2; i++)
        {
            for (int j = -size / 2; j < size / 2; j++)
            {
                glPushMatrix();
                    ...
                    if ((i+j) % 2 == 0) glColor3f (0.25, 0.125, 0.125);
                    else glColor3f(0.5,0.25,0.25);
...
void drawPrism(int vertAmount, float topModifier, float bottomMofidier)
{
    ...
    for (int vert = 0; vert < vertAmount; vert++)
    {
    ...
    for (int vert = vertAmount; vert < vertAmount * 2; vert++)
    {
        ...
        else
        {
            ...
            glPushMatrix();
                ...
                glPushMatrix();
                    ...
                    glColor4f(0.2f, 0.7f, 0.4f, 1.0f);
                    drawPrism(11, 0.5f, 1.0f);
                glPopMatrix();

                glPushMatrix();
                    glTranslatef(-2.0f, -2.5f, 0.0f);
                    glColor4f(0.2f, 0.7f, 0.4f, 0.8f);
                    drawPrism(11, 0.5f, 1.0f);
                glPopMatrix();

                glPushMatrix();
                    glTranslatef(2.0f, 2.5f, 0.0f);
                    glColor4f(0.2f, 0.7f, 0.4f, 0.6f);
                    drawPrism(11, 0.5f, 1.0f);
                glPopMatrix();

                glPushMatrix();
                    glTranslatef(2.0f, -3.0f, 0.0f);
                    glColor4f(0.2f, 0.7f, 0.4f, 0.4f);
                    drawPrism(11, 0.5f, 1.0f);
                glPopMatrix();

                glPushMatrix();
                    glTranslatef(-2.0f, 3.0f, 0.0f);
                    glColor4f(0.2f, 0.7f, 0.4f, 0.2f);
                    drawPrism(11, 0.5f, 1.0f);
                glPopMatrix();
